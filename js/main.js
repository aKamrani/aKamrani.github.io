  ...
  $(function () {
    ...
    $("#contact_form").on("submit", function (e) {
      if (!e.isDefaultPrevented()) {
        Email.send({
          SecureToken: "6ad6cbc1-f36b-4486-a0b1-aa742c8ebc1a",
          To: "ceit.engineer@gmail.com",
          From: "akamrani.message@gmail.com",
          Subject: $('#form_subject').val() + ' - aKamrani Message',
          Body: 'name: ' + $('#form_name').val() + ' - email: ' + $('#form_email').val() + ' - subject: ' + $('#form_subject').val() + '<p></p>' + $('#form_message').val(),
        }).then((message) => {
        $('#form_email').val('');
        $('#form_subject').val('');
        $('#form_name').val('');
